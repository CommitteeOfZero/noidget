var LicensePage = function() {
    ...
    var tf = this.view.addTextField(lipsum);
    tf.richText = true;
    this.acceptedCheckBox =
        this.view.addCheckBox('I accept the terms of this license agreement.');
};
...
LicensePage.prototype.onNext = function() {
    if (!this.acceptedCheckBox.checked) {
        ng.window.messageBox('BUT THOU MUST.');
        return;
    }
...
var doPreviousCrap = function() {
    ...
    page.onNext = function() {
        ...
        page2.addRadioGroup({
            text: 'Horizontal',
            options: [
                {name: '480p', text: '854x480'},
                {name: '576p', text: '1024x576'},
