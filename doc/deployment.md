You need to create a [Qt resource file](http://doc.qt.io/qt-5/resources.html#external-binary-resources) called `userdata.rcc` in the noidget.exe directory and supply graphical assets:
